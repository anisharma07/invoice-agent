      ...
      <IonHeader className="files-modal-header">
        <IonToolbar style={{ minHeight: "56px", "--min-height": "56px" }}>
          ...
          <IonButtons slot="end">
            <IonButton
              fill="clear"
              onClick={() => history.push("/app/invoice-store")}
                  ...
                  >
                    ...
                    >
                      {templateData?.ImageUri ? (
                        <img
                          src={`data:image/png;base64,${templateData.ImageUri}`}
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        {templateData?.name || `Template ${invoice.templateId}`}
                      </p>
                      <p
                        style={{
                          margin: "0",
                      ...
                      >
                        {new Date(invoice.modified).toLocaleDateString()}
                      </p>
                    </div>
                    <IonIcon
                      icon={chevronForward}
